...
/*
Dial: setup connection and receive
Go: async send,
Call: sync send
Close:
*/
...
// NewHTTPClient new a Client instance via HTTP as transport protocol using CONNECT method
...
// use context.WithTimeout control Duration
